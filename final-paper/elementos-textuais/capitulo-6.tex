...
\subsection*{Experimento 1 — Detecção de Colisões Entre Objetos Convexas}
...
\subsection*{Experimento 2 — Simulação Multi-Threaded}
...
\subsection*{Experimento 3 - Comparação Com Box2D}
