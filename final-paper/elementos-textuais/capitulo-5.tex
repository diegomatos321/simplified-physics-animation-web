...
\textbf{REALIZAR ANÁLISE DE COMPLEXIDADE}

Após filtrar a lista de pares, é feito um segundo passo de refinamento que realiza testes geométricos precisos, essa fase é chamada de \textit{Narrow Phase}. Utiliza-se algoritmos complexos como: SAT, GJK e EPA como visto anteriormente. A complexidade é reduzida aos pares realmente necessários, tipicamente em número linear no tamanho da cena.
