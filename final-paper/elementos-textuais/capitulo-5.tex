...
\begin{itemize}
	...
	$$i = \lfloor{\frac{x}{C}}\rceil, \quad j = \lceil{\frac{y}{C}}\rceil,
	$$
	...
	$$$$
\end{itemize}
Dessa forma temos uma grade regular que mepeia um mundo de tamanho arbitrário (possivelmente infinito) em um grade regular de tamanho constante.
...
O segundo passo de refinamento realiza testes geométricos precisos nos pares de candidatos P, essa fase é chamada de \textit{Narrow Phase}. Utiliza-se algoritmos complexos como: SAT, GJK e EPA como visto anteriormente para determinar se os objetos estão de fato colidindo. 
