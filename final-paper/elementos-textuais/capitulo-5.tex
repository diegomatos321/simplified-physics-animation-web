...
Divide-se o processo de detecção de colisão em duas partes: uma filtragem dos pares que não precisam ser testados pois, claramente não estão em colisão, e um refinamento nos pares que podem ou não colidir. Essa ideia consiste em fazer testes rápidos entre os objetos para descartar pares que seguramente não estão em colisão. Para isso usa-se a ideia de objetos delimitadores e também o conceito de localização espacial. 
