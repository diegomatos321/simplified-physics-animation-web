...
\begin{figure}[htb]
	...
	\caption{A distância atual entre as partículas P1 e P2 está inválida e deve ser corrigida por projeção.}
    \label{fig:correcao}
\end{figure}
...
\begin{figure}[htb]
	...
	\caption{A articulação é formada simplesmente fazendo os dois corpos compartilharem a mesma partícula}
...
Um politopio é um objeto geométrico com lados planos (faces). Os politopos são a generalização dos poliedros tridimensionais para qualquer número de dimensões. Os politopos podem existir em qualquer número geral de dimensões n como um polítopo n-dimensional ou n-polítopo. Por exemplo, um polígono é um 2-politopo e um poliedro é um 3-politopo.