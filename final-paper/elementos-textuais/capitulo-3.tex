...
No entanto, o processo de encontrar o simplex ideal elimina a necessidade de verificar quatro dessas regiões. Como o ponto de suporte A foi o primeiro a ser adicionado, B foi o segundo e C foi o terceiro. O ponto de suporte C foi adicionado como resultado de encontrar o vetor normal para $\overline{AB}$. Isso significa que a região de Voronoi $E_{AB}$, não pode conter a origem. As três regiões de Vértice também não podem conter a origem, uma vez que essas regiões estão além dos três pontos de apoio do simplex, que foram derivados dos pontos de suporte, que ficam no limite do CSO. Isso deixa apenas as regiões de Voronoi $E_{AC}$, $E_{BC}$ e $\triangle ABC$ para investigar.
