...
% \includegraphics[page=1]{ficha-catalografica.pdf}
% \end{figure}
% Opcionalmente você pode usar
\includepdf[pages={1}]{figuras/ficha-catalografica.pdf}
...
\input{elementos-textuais/capitulo-6.tex}

\input{elementos-textuais/capitulo-7.tex}

% \input{elementos-textuais/capitulo-8.tex}

% \input{elementos-textuais/capitulo-9.tex}
